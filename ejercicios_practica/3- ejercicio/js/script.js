...
acumuladorCards += `<article class="${tipoAgua.estiloClase}">
<div class="header">
    ${tipoAgua.titulo}
</div>            
<div>
...
`
acumuladorCards += `<article class="${tipoPlanta.estiloClase}">
<div class="header">
    ${tipoPlanta.titulo}
</div>            
<div>
...
`
acumuladorCards += `<article class="${tipoElectricidad.estiloClase}">
<div class="header">
...
`
acumuladorCards += `<article class="${tipoNormal.estiloClase}">
<div class="header">
    ${tipoNormal.titulo}
</div>            
<div>
...
`
acumuladorCards += `<article class="${tipoFuego.estiloClase}">
<div class="header">
    ${tipoFuego.titulo}
</div>            
<div>
